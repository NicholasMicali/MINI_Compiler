   ...
   extends AbstractExpression
{
   ...
   //public List aggregateDotExpression(List ids, HashMap<String, HashMap<String, Type>> typeTable, HashMap<String, Type> symbolTable, HashMap<String, Type> localTable)
   //{
   //   return null;
   //}
   ...
   {
      String leftReg = left.llvm(instructions, counter, params, structList, structVarMap, globs);
      String rightReg = right.llvm(instructions, counter, params, structList, structVarMap, globs);
      ...
      {
         String ty = "i64";
         Instruction prevInst = instructions.get(instructions.size()-1);
         if (prevInst.getClass().equals(LoadInstruction.class))
         {
            LoadInstruction prevLoad = (LoadInstruction)prevInst;
            ty = prevLoad.ty;
         }
         ...
         return iResult;
         //tResult = counter.newReg();
         //instructions.add(new BitInstruction(tResult, "zext", "i1", result, "i64"));
      }
      return result;
   }
